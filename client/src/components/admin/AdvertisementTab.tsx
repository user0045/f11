  ...
  return (
    <div className="space-y-6">
                ...
                <div className="flex items-start justify-between">
                  ...
                  <div className="flex items-center space-x-2">
                    <Dialog>
                      ...
                      <DialogContent className="bg-card/95 backdrop-blur-lg border border-border/30 z-[99995] advertisement-popup">
                        <DialogHeader>
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <AlertDialogContent className="bg-card/95 backdrop-blur-lg border border-border/30 z-[99995] advertisement-popup">
          <AlertDialogHeader>
