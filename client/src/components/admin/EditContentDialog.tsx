...
const EditContentDialog: React.FC<EditContentDialogProps> = ({
  ...
  if (loadingContent) {
    return (
      <Dialog open={open} onOpenChange={onClose}>
        <DialogContent className="bg-card/95 backdrop-blur-lg border border-border/50 max-w-6xl max-h-[90vh] overflow-y-auto z-[99995] edit-content-dialog">
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="bg-card/95 backdrop-blur-lg border border-border/50 max-w-6xl max-h-[85vh] overflow-y-auto z-[99995] edit-content-dialog">
